  ...
  return (
    <section id="hero" className="min-h-screen flex items-center justify-center relative overflow-hidden pt-20">
      ...
      <div className="relative z-10 text-center px-6 max-w-5xl">
        ...
        <h2 className="text-2xl md:text-4xl font-semibold text-gray-300 mb-8 animate-fade-in-up" style={{ animationDelay: '0.3s' }}>
          Data Analyst
        </h2>
        
        <p className="text-xl md:text-2xl text-gray-400 mb-12 max-w-3xl mx-auto animate-fade-in-up" style={{ animationDelay: '0.6s' }}>
          Turning data into meaningful insights and driving business decisions through 
        ...
        <div className="flex flex-col sm:flex-row gap-6 justify-center animate-fade-in-up" style={{ animationDelay: '0.9s' }}>
          ...
          <a
  href="/PrasannaKumar_Resume.pdf"  // 🔗 replace with your resume file path or Google Drive link
  target="_blank"
